...
public class CrossCountryAssignment {
	...
	public static void main(String[] args) {
		...
		String runnerFiveFinalTimeFirstSplit = runnerFiveMinsFirstSplit + ":" + formatter.format(runnerFiveSecsFirstSplit);
		...
		String runnerFiveFinalTimeSecondSplit = runnerFiveMinsSecondSplit + ":" + formatter.format(runnerFiveSecsSecondSplit);
		...
		String runnerFiveFinalTimeThirdSplit = runnerFiveMinsThirdSplit + ":" + formatter.format(runnerFiveSecsThirdSplit);
