...
public class HangMan {
    ...
    static final int TOTAL_POINTS = 3;
    static final int SPACES = 50;
    static final int TOTAL_TURNS = 1;
    static final int EMPTY = 0;

    public static void main(String[] args) {
    	System.out.println("Welcome to Hangman, where friend turns on freind all for the sweet reward of victory!\n");
        ...
        boolean tie = false;
        System.out.println("IT IS TIME FOR " + playerOne + " AND " + playerTwo + " TO BE PUT TO A CHALLENGE OF WITS!");
        while (!gameOver) {
            ...
            while (playerOneTurn) {
                ...
                while (invalid) {
                    ...
                    for (int i = 0; i < playerOnePhrase.length(); i++) {
                        ...
                        if (ACCEPTED_CHARACTERS.indexOf(playerOnePhrase.charAt(i)) == -1) {
                            System.out.println("/n Invalid word, please only use valid alpha-numerical characters..");
                            break;
                        }
                ...
                for (int i = TOTAL_POINTS; i > 0; i--) {
                    ...
                    if (i != 1) {
                        ...
                        // if the player chooses to guess a letter +++++++++++ADD INVALID CHAR LOOP TO ALL++++++++++++++
                        if (choice.equals("1")) {
                            ...
                            if (ACCEPTED_GUESSES.indexOf(guess) == -1) {
                                System.out
                                    .print("/n Invalid word, please only use valid alpha-numerical characters..");
            ...
            while (tie) {
                System.out.println("This has gotten interesting. " + playerOne + " and " + playerTwo +
                    ", you are both tied with " + playerOnePoints + "points");
                ...
                while (tieGuessing) {
                    ...
                    while (playerOneTurnTie) {
                        ...
                        String playerOnePhrase = "";
                        boolean invalid = true;
                        // seeing if phrase works. checks if it is empty and if
                        // it has all valid characters
                        while (invalid) {
                        	System.out.print(playerOne + ", select a phrase");
                            playerOnePhrase = keyboard.nextLine().toUpperCase();
                        ...
                        // loop for amount of guesses and points
                        for (int i = TOTAL_POINTS; i > 0; i--) {
                            // this is so they will be able to exit the loop if
                            // they
                            // guess the write answer and after they get the
                            // final guess
                            ...
                            // this is for if the player is being forced to
                            // guessed
                            if (i == 1) {
                                System.out.print("Out of guesses" + playerTwo +
                                    ". Time to guess what the phrase is.\nWhat do you think the phrase is?");
                    ...
                    while (playerTwoTurnTie) {
                        ...
                        if (playerOnePoints == playerTwoPoints)
                            System.out.println("It seems like there is still a tie " + playerOne + " " + playerTwo +
                                ". We will do another turn each to see if that breaks the tie.");
                        if (playerOnePoints != playerTwoPoints) {
